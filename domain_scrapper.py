...
#This is final project of IT students form Government Polytechnic Mumbai.
#It's name is Domain Scrapper where it refers to a website scanner.
#It focuses on Subdomain enumeration along with Port scanning.
...
______                      _         _____                                      
|  _  \                    (_)       /  ___|                                     
| | | |___  _ __ ___   __ _ _ _ __   \ `--.  ___ _ __ __ _ _ __  _ __   ___ _ __ 
| | | / _ \| '_ ` _ \ / _` | | '_ \   `--. \/ __| '__/ _` | '_ \| '_ \ / _ \ '__|
| |/ / (_) | | | | | | (_| | | | | | /\__/ / (__| | | (_| | |_) | |_) |  __/ |   
|___/ \___/|_| |_| |_|\__,_|_|_| |_| \____/ \___|_|  \__,_| .__/| .__/ \___|_|   
                                                          | |   | |              
                                                          |_|   |_""" + R + "\n\t\t\t\tby Diploma Students of GPM IT Branch --->  " + B + " FS21IF063\n\t\t\t\t\t\t\t\t\t    FS21IF045\n\t\t\t\t\t\t\t\t\t    FS21IF036\n\t\t\t\t\t\t\t\t\t    SS21IF051\n" + W)
...
|___/ \___/|_| |_| |_|\__,_|_|_| |_| \____/ \___|_|  \__,_| .__/| .__/ \___|_|   
                                                          | |   | |              
                                                          |_|   |_""" + R + " by Diploma Students of GPM IT Branch --->  " + G + "FS21IF063\n\t\t\t\t\t\t\t\t\t\t\t\t\t\tFS21IF045\n\t\t\t\t\t\t\t\t\t\t\t\t\t\tFS21IF036\n\t\t\t\t\t\t\t\t\t\t\t\t\t\ttSS21IF051\n" + W)
